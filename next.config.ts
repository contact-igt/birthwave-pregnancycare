...
const cspHeader = `
  ...
  connect-src 'self' https://www.google-analytics.com https://*.google-analytics.com https://*.analytics.google.com https://*.googletagmanager.com https://tagmanager.google.com https://*.g.doubleclick.net https://*.doubleclick.net https://doubleclick.net https://ad.doubleclick.net https://*.googleadservices.com https://googleadservices.com https://*.googlesyndication.com https://*.google.com https://*.google.co.in https://stats.g.doubleclick.net https://www.clarity.ms https://*.clarity.ms https://c.bing.com https://api.whatsapp.com https://wa.me;
